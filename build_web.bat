...
set EMSCRIPTEN_SDK_DIR=D:\08_dev\emsdk
...
odin build src\main_web -o:speed -target:js_wasm32 -build-mode:obj -define:RAYLIB_WASM_LIB=env.o -define:RAYGUI_WASM_LIB=env.o -vet -out:%OUT_DIR%\game
