...
// include: C:\Users\Jiri\AppData\Local\Temp\tmpsjdf63z0.js
...
Module['FS_createPath']("/", "assets", true, true);
    ...
    loadPackage({"files": [{"filename": "/assets/NotoSansJP-Regular.ttf", "start": 0, "end": 5733060}, {"filename": "/assets/SimHei.ttf", "start": 5733060, "end": 15485020}, {"filename": "/assets/codepoints.txt", "start": 15485020, "end": 15487917}, {"filename": "/assets/long_cat.png", "start": 15487917, "end": 15488100}, {"filename": "/assets/round_cat.png", "start": 15488100, "end": 15488417}], "remote_package_size": 15488417});

  })();

// end include: C:\Users\Jiri\AppData\Local\Temp\tmpsjdf63z0.js
// include: C:\Users\Jiri\AppData\Local\Temp\tmp2mbm8ie2.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\Jiri\AppData\Local\Temp\tmp2mbm8ie2.js
// include: C:\Users\Jiri\AppData\Local\Temp\tmp7z5tfp95.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\Jiri\AppData\Local\Temp\tmp7z5tfp95.js
...
var ASM_CONSTS = {
  148544: () => { if (document.fullscreenElement) return 1; },  
 148590: () => { return document.getElementById('canvas').width; },  
 148642: () => { return parseInt(document.getElementById('canvas').style.width); },  
 148710: () => { document.exitFullscreen(); },  
 148737: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 148810: () => { if (document.fullscreenElement) return 1; },  
 148856: () => { return document.getElementById('canvas').width; },  
 148908: () => { return screen.width; },  
 148933: () => { document.exitFullscreen(); },  
 148960: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 149093: () => { return window.innerWidth; },  
 149119: () => { return window.innerHeight; },  
 149146: () => { if (document.fullscreenElement) return 1; },  
 149192: () => { return document.getElementById('canvas').width; },  
 149244: () => { return parseInt(document.getElementById('canvas').style.width); },  
 149312: () => { if (document.fullscreenElement) return 1; },  
 149358: () => { return document.getElementById('canvas').width; },  
 149410: () => { return screen.width; },  
 149435: () => { return window.innerWidth; },  
 149461: () => { return window.innerHeight; },  
 149488: () => { if (document.fullscreenElement) return 1; },  
 149534: () => { return document.getElementById('canvas').width; },  
 149586: () => { return screen.width; },  
 149611: () => { document.exitFullscreen(); },  
 149638: () => { if (document.fullscreenElement) return 1; },  
 149684: () => { return document.getElementById('canvas').width; },  
 149736: () => { return parseInt(document.getElementById('canvas').style.width); },  
 149804: () => { document.exitFullscreen(); },  
 149831: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 149889: () => { return screen.width; },  
 149914: () => { return screen.height; },  
 149940: () => { return window.screenX; },  
 149967: () => { return window.screenY; },  
 149994: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 150047: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 150118: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 150175: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 150431: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 150502: () => { if (document.fullscreenElement) return 1; },  
 150548: () => { return window.innerWidth; },  
 150574: () => { return window.innerHeight; },  
 150601: () => { if (document.pointerLockElement) return 1; }
};
var wasmImports = {
  /** @export */
